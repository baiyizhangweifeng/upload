...
def load_mnist(path, kind='train'):
	...
	if kind=='train':
		labels_path=os.path.abspath('G:\github-clone-file\Tensorflow_Lenet5\MNIST_data\train-labels.idx1-ubyte')		
		images_path=os.path.abspath('G:\github-clone-file\Tensorflow_Lenet5\MNIST_data\train-images.idx3-ubyte')
	else:
		labels_path=os.path.abspath('G:\github-clone-file\Tensorflow_Lenet5\MNIST_data\t10k-labels.idx1-ubyte')		
		images_path=os.path.abspath('G:\github-clone-file\Tensorflow_Lenet5\MNIST_data\t10k-images.idx3-ubyte')
